...
export default function Home({params: {projectId}}) {
    ...
    const projectsArray =  [
        ...
        link:'https://kodeum-lk.github.io/sentosa/',
        Insutry: 'Hotel',
        ...
        link:'https://kodeum-lk.github.io/photographer-portfolio/',
        Insutry: 'Photography',
        ...
        link:'https://kodeum-lk.github.io/dream-crest/',
        Insutry: 'Real Estate',
                    ...
                    <div className="auto-container">
                        ...
                        <div className="image-box">
                            <div style={{display: 'flex', justifyContent: 'center'}} className="row">
                                ...
                                <div className="col-lg-6">
                                   <Link href={selectedProject?.link} target="blank" ><div className="image mb-30"><img src={selectedProject?.image} alt="" /></div></Link>
                                </div>
                            </div>
                        </div>
                    </div>
