...
export default function Contact() {
    return (
        <>
            <section className="contact-section-home15" style={{ backgroundImage: 'url(assets/images-4/background/banner.png)' }}>
                <div className="auto-container">
                    ...
                    <div style={{display: 'flex', flexDirection: 'column', alignItems: 'center'}} className="form-inner">
                        ...
                        <Link style={{marginTop: '30px'}}  href="/contact-us" className="theme-btn btn-style-ten"><span className="btn-title">Let's Collaborate</span></Link>
                    </div>
                </div>
            </section>
        </>
